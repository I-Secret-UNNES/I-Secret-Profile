            ...
            <div className="py-12">
                <div className=" max-w-7xl mx-auto sm:px-6 lg:px-8"> 
                    ...
                    <div className="mx-auto bg-slate-900 p-5 min-h-80 rounded-lg">
                        ...
                        <div className="lg:mx-32 mt-8 md:flex lg:flex grid-cols-2 gap-y-4 gap-4 mb-10">
                            <div className="min-h-40 min-w-30 border-2 p-4 rounded-2xl hover:bg-indigo-800 transition-all duration-200">
