...
const Body = (props) => {
    ...
    function removeTagsAndExtractText(html) {
        ...
        if (withoutHtmlTags.length > 500) {
            return withoutHtmlTags.slice(0, 500) + '...';
        }
    ...
    return (
        <div className="flex flex-col justify-between gap-4 lg:px-7 lg:col-span-2 py-4 lg:py-2">
            ...
            <p className="w-full text-justify font-base text-slate-800 text-sm" dangerouslySetInnerHTML={{ __html: removeTagsAndExtractText(children) }}  ></p>
            <Link
                ...
                href={route('detail.project', props.slug)}
