...
function ListProject({ datas, APP_URL, setData, setIsUpdate, openModal }) {
                                ...
                                <tr key={data.id} className="hover:bg-black/[0.1]">
                                    ...
                                    <td className="w-36">
                                        <div className="grid grid-cols-2 gap-5">
                                            <Link href={route('project.edit', data.slug)} className="btn btn-warning px-1">
                                            ...
                                            <button onClick={ () => onDeleteHandler(data.id)} className="btn btn-error px-1" >
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 stroke-2">
